...
const EditFluidPage = () => {
	...
	return (
		<PageWrapper title=''>
			<SubHeader children={undefined}></SubHeader>
											...
											<div className='row g-4'>
												...
												<div className='col-lg-3'>
													<FormGroup
														...
														isFloating>
														<Input
															placeholder='Number of Contract'
															autoComplete='additional-name'
															onChange={formik.handleChange}
															onBlur={formik.handleBlur}
															value={formik.values.firstName}
												...
												<div className='col-lg-2'>
													<FormGroup
														id='DealerOrderNumber'
														label='Dealer Order Number'
														isFloating>
														<Input
															placeholder='Number of Dealer Order'
															autoComplete='additional-name'
															onChange={formik.handleChange}
															onBlur={formik.handleBlur}
															value={formik.values.firstName}
												...
												<div className='col-lg-2'>
													<FormGroup id='Terms' label='Terms' isFloating>
														<Input
															placeholder='Terms'
															autoComplete='additional-name'
															onChange={formik.handleChange}
												...
												<div className='col-lg-2'>
													<FormGroup
														id='DiscountDays'
														label='Discount Days Due'
														isFloating>
														<Input
															placeholder='Discount Days Due'
															autoComplete='additional-name'
															onChange={formik.handleChange}
															onBlur={formik.handleBlur}
															value={formik.values.firstName}
												...
												<div className='col-lg-2'>
													<FormGroup
														...
														isFloating>
														<Input
															placeholder='Carrier Alpha Code'
															autoComplete='additional-name'
															onChange={formik.handleChange}
															onBlur={formik.handleBlur}
															value={formik.values.firstName}
												...
												<div className='col-lg-2'>
													<FormGroup
														id='ShipperFacsimile'
														label='Shipper Facsimile'
														isFloating>
														<Input
															placeholder='Shipper Facsimile'
															autoComplete='additional-name'
															onChange={formik.handleChange}
															onBlur={formik.handleBlur}
															value={formik.values.firstName}
										...
										<CardBody>
											...
											<div className='col-lg-3'>
													<FormGroup
														...
														isFloating>
														<Input
															placeholder='PartNumber/Description'
															autoComplete='additional-name'
															onChange={formik.handleChange}
															onBlur={formik.handleBlur}
															value={formik.values.firstName}
