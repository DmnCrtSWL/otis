...
const LANDING = {
	...
	HOME: lazy(() => import('../pages/presentation/demo-pages/Home')),
};
const SINGLE = {
...
const GRID = {
	BOXED: lazy(() => import('../pages/presentation/demo-pages/GridFluidPage')),
	ORDER: lazy(() => import('../pages/presentation/demo-pages/GridFluidPageOrder')),
	FLUID: lazy(() => import('../pages/presentation/demo-pages/GridFluidPage')),
	NEW_PO: lazy(() => import('../pages/presentation/demo-pages/New-PO')),
	VIEW_PO: lazy(() => import('../pages/presentation/demo-pages/View-PO')),
